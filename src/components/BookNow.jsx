...
import unithink from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/UniThink.png'
import boundless from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/Boundless.png'
import rethink from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/ReThink.png'
import student from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/student.png'
                ...
                <div className="flex flex-col items-center justify-center pt-10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-7xl mx-auto">
                        ...
                        <Button pill gradientDuoTone='pinkToOrange' onClick={scrollToTop}  outline className="absolute top-48 right-2 z-1 border border-red-500 p-0 m-0"><HiArrowCircleRight size={30}/>Book Now!</Button>
                            ...
                            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white pt-5">
