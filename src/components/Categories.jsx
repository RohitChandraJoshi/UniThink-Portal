...
import verti2 from "G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/partners.png"
import verti3 from "G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/analysis.png"
import verti4 from "G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/business.png"
      ...
      <div className="max-w-[1600px] mx-auto py-10">
        ...
        <div className="w-full mx-auto lg:px-3 px-1 lg:flex items-center gap-14 lg:mt-10 mt-2">
          ...
          <div className=" lg:2/4  w-full flex items-center justify-center py-2 rounded-full">
              <img src={verti1} alt="" style={{ width: "100px", height: "100px" }}/>
            </div>
          ...
          <div className = "card">
            ...
            <div className=" lg:2/4  w-full flex items-center justify-center py-2 rounded-full">
              <img src={verti2} alt="" style={{ width: "100px", height: "100px" }}/>
            </div>
            <h4 className="font-heebo text-2xl">Community</h4>
            <p className="text-center p-4 font-semibold text-[#4c0f0f] text-lg">
          ...
          <div className=" lg:2/4  w-full flex items-center justify-center py-2 rounded-full">
              <img src={verti3} alt="" style={{ width: "100px", height: "100px" }}/>
            </div>
            <h4 className="font-heebo text-2xl">Training and Skill Development</h4>
            <p className="text-center p-4 font-semibold text-[#4c0f0f] text-lg">
          ...
          <div className = "card">
          <div className=" lg:2/4  w-full flex items-center justify-center py-2 rounded-full">
              <img src={verti4} alt=""style={{ width: "100px", height: "100px" }} />
            </div>
            <h4 className="font-heebo text-2xl">Education and Business Consulting</h4>
            <p className="text-center p-4 font-semibold text-[#4c0f0f] text-lg">
