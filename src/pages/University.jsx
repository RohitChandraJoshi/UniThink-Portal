...
import counsellingImage from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/about1.png';
...
import skills from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/skills.jpg'
import business from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/business.jpg'
import university from 'G:/Projects/Unithink/Unithink-main/Unithink-main/Client/src/assets/university.jpg'
    ...
    <div>
        ...
        <div className="sttt">
              <h1 className='mb-4 font-bold text-3xl md:text-3xl lg:text-4xl text-black relative flex flex-col items-center'>
                <span className='mt-10'>Find Your University & Course</span>
            ...
            <p className="w-full  lg:pb-3 lg:text-base text-[10px] pt-3 text-center text-gray-900">Welcome to your personalized journey towards academic and professional success! Whether you’re taking your first step into higher education or seeking advanced studies, we’re here to help you find the perfect university and course tailored to your goals.

</p>
          </div>
          <div className="discover">
            <p className="w-full  lg:pb-3 lg:text-base text-[10px] pt-3 text-center text-gray-900">Your Journey Starts Here: Explore Top Universities and Courses
